...
class Stats():
    def __init__(self, torrentFileInfo):
        ...
        self.totalDownloadSpeed = 0.0
        self.avgDownloadSpeed = 0.0
        self.uploadSpeed = 0.0
        self.maxUploadSpeed = 0.0
        self.totalUploadSpeed = 0.0
        self.avgUploadSpeed = 0.0
    ...
    def setDownloadSpeed(self, pieceNumber):
        ...
        self.downloadSpeed = round(pieceSizeKB / timeTaken, 2)
    ...
    def setUploadSpeed(self, pieceNumber):
        ...
        pieceSizeKB = currentPieceLength / 1024
        timeTaken = (self.endTime - self.startTime)
        self.uploadSpeed = round(pieceSizeKB / timeTaken, 2)
